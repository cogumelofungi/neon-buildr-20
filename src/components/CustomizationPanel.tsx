    ...
    <Card className="bg-app-surface border-app-border p-4 sm:p-6 pb-6 sm:pb-8 space-y-4 sm:space-y-6">
      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        <TabsContent value="general" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
          ...
          {(appData.template === 'classic' || appData.template === 'showcase' || appData.template === 'modern' || appData.template === 'corporate' || appData.template === 'flow' || appData.template === 'members' || appData.template === 'academy') && (
        ...
        <TabsContent value="labels" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
          ...
          {/* View Button Label - Hidden for Units, Flow, Modern, Academy, Shop */}
          {!['units', 'flow', 'modern', 'members', 'academy', 'shop'].includes(appData.template) && (
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={t("custom.view.button.placeholder")}
                className="bg-app-surface-hover border-app-border focus:border-primary"
              />
