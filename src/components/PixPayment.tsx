...
const PixPayment = ({ planName, amount, onPaymentConfirmed, onCancel }: PixPaymentProps) => {
  ...
  useEffect(() => {
    ...
    const simulatedPixCode = `00020126360014BR.GOV.BCB.PIX0114+5511999999999520400005303986540${amount.replace('R$', '')}5802BR5925PLR App Builder6009SAO PAULO62070503***6304`;
