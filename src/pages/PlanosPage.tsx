              ...
              {language === "pt" ? (
                <>
                  <span className="sm:hidden">
                    Mesmo produto, novo formato, nova percepção. Seus clientes vão pagar preço premium (sem você
                    programar nada)
                  </span>
                  <span className="hidden sm:inline">
                    Mesmo produto, novo formato, nova percepção.
                    <br />
                    Seus clientes vão pagar preço premium (sem você programar nada)
                  </span>
                </>
              ) : language === "en" ? (
                <>
                ...
                <>
                  <span className="sm:hidden">
                    Mismo producto, nuevo formato, nueva percepción. Tus clientes pagarán precio premium (sin que
                    programes nada)
                  </span>
                  <span className="hidden sm:inline">
                    Mismo producto, nuevo formato, nueva percepción.
                    <br />
                    Tus clientes pagarán precio premium (sin que programes nada)
                  </span>
                </>
              )}
            </EditableElement>
            ...
            <div className="space-y-4 sm:space-y-6 max-w-4xl mx-auto text-left">
              ...
              <div className="flex flex-col items-start gap-2 sm:gap-3 text-[18px] sm:text-[20px] md:text-2xl text-[#374151] dark:text-[#CCCCCC]">
                ...
                <p className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#2054DE] flex-shrink-0" />
                  {language === "pt"
                    ? "Permite cobrar 2-3x mais pelo mesmo conteúdo"
                    : language === "en"
                      ? "Allows charging 2-3x more for the same content"
                      : "Permite cobrar 2-3x más por el mismo contenido"}
                </p>
                <p className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#2054DE] flex-shrink-0" />
                  {language === "pt"
                    ? 'Elimina objeções de "é só um PDF"'
                    : language === "en"
                ...
                <p className="flex items-center gap-3">
                  <CheckCircle2 className="w-5 h-5 text-[#2054DE] flex-shrink-0" />
                  {language === "pt"
                    ? "Aumenta percepção de exclusividade e profissionalismo"
                    : language === "en"
                      ? "Increases perception of exclusivity and professionalism"
                      : "Aumenta percepción de exclusividad y profesionalismo"}
                </p>
              </div>
