...
import { Star, LogOut, ArrowLeft, ShoppingBag, Trophy } from 'lucide-react';
...
const Conta = () => {
  const { user, profile, loading, loyaltyPoints, loyaltyActive, signOut, refreshPoints } = useCustomerAuth();
