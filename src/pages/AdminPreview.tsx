...
const AdminPreview = () => {
  ...
  const { t } = useLanguage();
  const [selectedTemplate, setSelectedTemplate] = useState<'classic' | 'corporate' | 'showcase' | 'modern'>('classic');
  ...
  const effectiveTemplate = (activeCustom.template || selectedTemplate) as 'classic' | 'corporate' | 'showcase' | 'modern';
        ...
        <div className="container max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">{t("admin.preview.title")}</h1>
                <p className="text-muted-foreground">{t("admin.preview.subtitle")}</p>
              </div>
            </div>
