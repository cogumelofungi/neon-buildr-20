      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold">
            {settings.support_title || t('support.default_title')}
          </CardTitle>
          <CardDescription className="text-center">
            {settings.support_description || t('support.default_description')}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          ...
          >
            ...
            {settings.support_button_text || t('support.default_button')}
          </Button>
          
          <div className="text-center text-sm text-muted-foreground">
            <p>{t('support.response_message')}</p>
          </div>
        </CardContent>
      </Card>
    </div>
